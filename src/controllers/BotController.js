...
class BotController extends BaseController {
    ...
    setupRoutes() {
        // Webhook endpoint
        this.registerRoute('post', '/webhook/telegram', this.handleWebhook.bind(this));
        
        // Bot management
        this.registerRoute('post', '/api/bot/set-webhook', this.setWebhook.bind(this), [this.requireAuth.bind(this)]);
        this.registerRoute('get', '/api/bot/info', this.getBotInfo.bind(this), [this.requireAuth.bind(this)]);
        this.registerRoute('post', '/api/bot/send-message', this.sendMessage.bind(this), [this.requireAuth.bind(this)]);
        
        // Bot health
        this.registerRoute('get', '/api/bot/health', this.getBotHealth.bind(this));
    }
    ...
    async sendMessage(req, res) {
        try {
            ...
            const result = await telegramBotService.sendMessage(chatId, text, options || {});
